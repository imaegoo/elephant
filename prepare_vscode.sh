...
if [[ "${DISABLE_UPDATE}" != "yes" ]]; then
  ...
  setpath "product" "downloadUrl" "https://github.com/imaegoo/elephant/releases"
fi
...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  ...
  setpath "product" "applicationName" "elephant"
  setpath "product" "linuxIconName" "elephant"
  setpath "product" "quality" "stable"
  setpath "product" "urlProtocol" "elephant"
  setpath "product" "serverApplicationName" "elephant-server"
...
if [[ "${OS_NAME}" == "linux" ]]; then
  ...
  # control.template
  sed -i 's|Microsoft Corporation <vscode-linux@microsoft.com>|VSCodium Team https://github.com/imaegoo/elephant/graphs/contributors|'  resources/linux/debian/control.template
  ...
  sed -i 's|Visual Studio Code Team <vscode-linux@microsoft.com>|VSCodium Team https://github.com/imaegoo/elephant/graphs/contributors|' resources/linux/rpm/code.spec.template
